...
#include <cuda/std/detail/libcxx/include/__algorithm/ranges_min_element.h>
...
struct __fn
{
  ...
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const _Tp&
  ...
  _LIBCUDACXX_TEMPLATE(class _Tp, class _Proj = identity, class _Comp = _CUDA_VRANGES::less)
  _LIBCUDACXX_REQUIRES(indirect_strict_weak_order<_Comp, projected<const _Tp*, _Proj>>)
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr _Tp
  ...
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr range_value_t<_Rp>
