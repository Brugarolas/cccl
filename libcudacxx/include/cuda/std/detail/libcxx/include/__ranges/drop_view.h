...
#include <cuda/std/detail/libcxx/include/__ranges/non_propagating_cache.h>
...
struct __fn
{
  ...
  _LIBCUDACXX_REQUIRES(convertible_to<_Np, range_difference_t<_Range>> _LIBCUDACXX_AND
                         __is_repeat_specialization<_RawRange> _LIBCUDACXX_AND (!sized_range<_RawRange>))
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Range&& __range, _Np&&) const
