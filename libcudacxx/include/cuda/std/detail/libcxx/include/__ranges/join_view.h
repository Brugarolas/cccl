...
#include <cuda/std/detail/libcxx/include/__ranges/defaultable_box.h>
...
#include <cuda/std/detail/libcxx/include/__utility/as_lvalue.h>
...
private:
  ...
  _LIBCUDACXX_NO_UNIQUE_ADDRESS _OuterCache __outer_;
  _LIBCUDACXX_NO_UNIQUE_ADDRESS _InnerCache __inner_;
...
public:
  ...
  private:
    ...
    _LIBCUDACXX_NO_UNIQUE_ADDRESS _OuterType __outer_ = _OuterType();
