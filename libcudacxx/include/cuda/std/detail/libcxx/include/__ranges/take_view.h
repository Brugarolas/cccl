...
#include <cuda/std/detail/libcxx/include/__algorithm/ranges_min.h>
...
#include <cuda/std/detail/libcxx/include/__iterator/counted_iterator.h>
...
#include <cuda/std/detail/libcxx/include/__ranges/all.h>
#include <cuda/std/detail/libcxx/include/__ranges/concepts.h>
#include <cuda/std/detail/libcxx/include/__ranges/empty_view.h>
#include <cuda/std/detail/libcxx/include/__ranges/enable_borrowed_range.h>
#include <cuda/std/detail/libcxx/include/__ranges/iota_view.h>
#include <cuda/std/detail/libcxx/include/__ranges/range_adaptor.h>
#include <cuda/std/detail/libcxx/include/__ranges/repeat_view.h>
...
struct __fn
{
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Range&& __range, _Np&&) const
  ...
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Range&& __range, _Np&& __n) const
    noexcept(noexcept(views::repeat(*__range.__value_, _CUDA_VSTD::min<_Dist>(ranges::distance(__range), _CUDA_VSTD::forward<_Np>(__n)))))
    -> _RawRange
  { return            views::repeat(*__range.__value_, _CUDA_VSTD::min<_Dist>(ranges::distance(__range), _CUDA_VSTD::forward<_Np>(__n))); }
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator()(_Range&& __rng, _Np&& __n) const noexcept(noexcept(_CUDA_VRANGES::iota_view(
    *_CUDA_VRANGES::begin(__rng),
    *_CUDA_VRANGES::begin(__rng)
      + _CUDA_VSTD::min<_Dist>(_CUDA_VRANGES::distance(__rng), _CUDA_VSTD::forward<_Np>(__n)))))
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Np&& __n) const
